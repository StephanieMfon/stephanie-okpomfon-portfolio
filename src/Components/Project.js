...
function Project({
	...
	return (
		// <article className="rounded-xl mt-10 mt-10 dark:bg-dark-card ">
		<article className="rounded-xl mt-10 dark:bg-dark-card transform translate-y-4 hover:translate-y-0 duration-500 ease-in-out">
			<div className="rounded-t">
				<img src={image} alt="" loading="lazy" className="rounded-t" />
				{/* <div className="dark:bg-dark-card p-4 rounded-b"> */}
				{/* <div className={`dark:bg-dark-card p-4 rounded-b ${border_radius}`}> */}
				<div className={`p-4 rounded-b ${border_radius}`}>
